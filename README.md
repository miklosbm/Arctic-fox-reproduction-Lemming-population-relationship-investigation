...
**Result summary:** Arctic fox reproduction tracks lemming abundance in the same year (ρ = 0.75, p < 0.0001), but the finding should be read with some caution due to multi-year population cycles.
